...
export default function BoardPage() {
  const { state, origin, createTask, moveTask } = useRoya();
      ...
      {tasks.length === 0 ? (
        <div className="card text-center py-12">
          ...
          <p className="text-gray-600 text-sm mt-2">
            {scenes.length === 0
              ? "Analyze a screenplay and generate a schedule to populate the board."
              : "Create a task to start organizing the production."}
          </p>
        </div>
      ) : (
